        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#5865f2] rounded-full flex items-center justify-center">
              <Icon name="Figma" size={18} className="text-white" fallback="Monitor" />
            </div>
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-white">Дискордик</h1>
              <p className="text-xs text-[#b9bbbe] hidden sm:block">Rich Presence Figma → Discord</p>
            </div>
          </div>
      ...
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex w-[72px] bg-[#202225] flex-col items-center py-3 gap-2">
          <div className="w-12 h-12 bg-[#5865f2] rounded-2xl hover:rounded-xl transition-all duration-200 flex items-center justify-center cursor-pointer">
            <Icon name="Figma" size={24} className="text-white" fallback="Monitor" />
          </div>
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          >
            ...
            <div className="flex-1 p-2">
              <div className="mb-4">
                ...
                <div className="mt-1 space-y-0.5">
                  {["общий", "анонсы", "витрина", "помощь"].map((channel) => (
                    <div
                      key={channel}
            ...
            <div className="p-2 bg-[#292b2f] flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-white text-sm font-medium truncate">Дизайнер</div>
                <div className="text-[#b9bbbe] text-xs truncate">Работает в Figma</div>
              </div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="h-12 bg-[#36393f] border-b border-[#202225] flex items-center px-4 gap-2">
              ...
              <span className="text-[#8e9297] text-sm hidden sm:block">Покажи свою работу в Figma через Discord статус</span>
              <div className="ml-auto flex items-center gap-2 sm:gap-4">
                <Icon name="Bell" size={18} className="text-[#b9bbbe] cursor-pointer hover:text-[#dcddde]" />
                <Icon name="Users" size={18} className="text-[#b9bbbe] cursor-pointer hover:text-[#dcddde]" />
                <Icon name="Search" size={18} className="text-[#b9bbbe] cursor-pointer hover:text-[#dcddde]" />
              </div>
            </div>
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">Дискордик</span>
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    <p className="mb-3 sm:mb-4">
                      <strong>Привет, дизайнер! 👋</strong> Дискордик автоматически показывает что ты делаешь в Figma — прямо в твоём Discord статусе.
                    </p>
                    <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                      ...
                      <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                        ...
                        <li>✅ Показывает название текущего файла и фрейма</li>
                        <li>✅ Обновляет статус каждые 5 секунд в реальном времени</li>
                        <li>✅ Сбрасывает статус когда Figma закрыта</li>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">Мария · UI Designer</span>
                  ...
                  <div className="text-[#dcddde] mb-3 text-sm sm:text-base">
                    Поставила Дискордик — теперь команда всегда видит над чем я работаю 🔥
                  </div>
                      ...
                      <div className="mb-3 sm:mb-4">
                        <div className="bg-[#36393f] rounded-lg p-2 sm:p-3 relative">
                          ...
                          <div className="flex items-center gap-2 text-[#dcddde] text-xs sm:text-sm">
                            <span>🎨</span>
                            <span>Кипит работа над дизайном...</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-[#36393f] rounded-lg">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-[#dcddde] text-xs sm:text-sm mb-1">Редактирует: Главная страница</div>
                            <div className="text-[#b9bbbe] text-xs sm:text-sm mb-2">Файл: Landing v3.0</div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">Антон · Dev</span>
                    <span className="text-[#72767d] text-xs hidden sm:inline">Сегодня в 12:08</span>
                  </div>
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    Теперь сразу вижу когда дизайн готов — больше никаких «а ты закончила?» 😄
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6 mt-6 sm:mt-8">
                <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <Icon name="Download" size={22} className="text-[#5865f2]" />
                  Начни за 3 минуты
                </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  <div className="text-center">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Windows, macOS или Linux — бесплатно</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Авторизуйся через безопасный OAuth</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Статус обновится автоматически ✨</p>
                  </div>
                </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {[
                    {
                      icon: "Zap",
                      title: "Мгновенное определение",
                      desc: "Работает с Figma в браузере и десктопном приложении",
                    },
                    {
                      icon: "Eye",
                      title: "Умное отслеживание",
                      desc: "Показывает имя файла и текущего фрейма",
                    },
                    {
                      icon: "Clock",
                      title: "Реальное время",
                      desc: "Статус синхронизируется каждые 5 секунд",
                    },
                    {
                      icon: "Shield",
                      title: "Никакого трекинга",
                      desc: "Данные не покидают твой компьютер",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
                    ...
                    >
                      <div className="text-[#5865f2] mt-0.5">
                        <Icon name={feature.icon} size={18} fallback="Star" />
                      </div>
                      <div>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  {
                    name: "Дискордик",
                    status: "Разрабатывает Rich Presence",
                    avatar: "Д",
